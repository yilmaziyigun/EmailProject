	...
	<div class="wrapper">
					...
					<div class="row g-0">
						<div class="col-lg-6">
							<div class="card-body">
								...
								<div class="mt-5">
									<a href="javascript:;" class="btn btn-lg btn-primary px-md-5 radius-30">Go Home</a>
									<a href="javascript:;" class="btn btn-lg btn-outline-dark ms-3 px-md-5 radius-30">Back</a>
								</div>
							</div>
						</div>
						<div class="col-lg-6">
							<img src="assets/images/errors-images/505-error.png" class="card-img" alt="">
						</div>
					</div>
					<!--end row-->
				</div>
		...
		<div class="bg-white p-3 fixed-bottom border-top">
			<div class="d-flex align-items-center justify-content-between flex-wrap">
				...
				<p class="mb-0">Syndash @2021 | Developed By : <a href="https://themeforest.net/user/codervent" target="_blank">codervent</a></p>
			</div>
		</div>
	</div>
	<!-- end wrapper -->
